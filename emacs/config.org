...
** Dirvish
Gestor de archivos moderno sobre dired. Requiere en el sistema:
=sudo dnf install fd-find ffmpegthumbnailer mediainfo=

| Atajo | Acción                                            |
|-------+---------------------------------------------------|
| C-x d | Abre Dirvish (reemplaza dired normal)             |
| C-c d | Abre panel lateral (Dirvish Side)                 |
| TAB   | Expandir subdirectorio en árbol                   |
| a     | Acceso rápido a favoritos (home, develop, notas…) |
| M-t   | Toggle layout (panel de preview lateral)          |
| y     | Menú de copiar/mover archivos                     |
| v     | Menú de vc/git                                    |
| s     | Ordenar archivos                                  |
| M-j   | Saltar directorio con fd                          |

#+begin_src emacs-lisp
  (use-package dirvish
    :ensure '(dirvish :host github :repo "alexluigit/dirvish")
    :init
...
#+begin_src emacs-lisp
  (use-package markdown-mode
    ...
    (markdown-header-scaling-values '(1.8 1.5 1.3 1.1 1.0 0.9))
