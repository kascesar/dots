...
#+RESULTS:
| python-black-on-save-mode | #[nil ((require 'lsp-pyright) (lsp)) (t)] | set-flycheck-python-pylint-executable | flymake-ruff-load | pipenv-mode | lsp-deferred | company-mode | flycheck-mode | py-isort-before-save | black-mode | lsp |
