...
(set-face-attribute 'variable-pitch nil :family "Cantarell" :height 1.2)
#+end_src
...
#+BEGIN_SRC emacs-lisp :results silent
  ...
  ;;;; Python moderno (Pyrefly + Eglot + Ruff)

  ;; LSP core — built-in desde Emacs 29
  (use-package eglot
    :ensure nil
  ...
  ;; Autocompletado — company sigue funcionando igual
  (use-package company
    :ensure t
  ...
  ;; Documentación flotante — reemplaza lsp-ui-doc
  ...
  ;; Ruff formatter + fixer (sin cambios)
