...
* App launcher
Esto crea una ventana flotante que sumula un lanzador de aplicaciones hecho con emacs consul
...
(elpaca vterm-toggle
  ...
  (setq vterm-toggle-scope 'develop)
