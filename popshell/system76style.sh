...
# up/down usan flechas + k/i del layout jkli (k=abajo, i=arriba). No se usa j/l aquí
# porque ya los ocupa switch-to-workspace-left/right.
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-down  "['<Control><Super>Down',  '<Control><Super>KP_Down',  '<Control><Super>k']"
gsettings set org.gnome.desktop.wm.keybindings switch-to-workspace-up    "['<Control><Super>Up',    '<Control><Super>KP_Up',    '<Control><Super>i']"
