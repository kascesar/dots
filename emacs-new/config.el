...
| keys    | order            | desc                  |
|---------+------------------+-----------------------|
| C-f     | counsult-grep    | buscar recursivamente |
| M-s M-f | counsult-find    |                       |
| M-s M-o | counsult-outline | buscar en el header   |
| C-s M-l | counsult-line    | buscar en el bufer    |
...
#+BEGIN_SRC sh :results silent
  pip install -U 'python-lsp-server[all]' black isort pyright
#+END_SRC
