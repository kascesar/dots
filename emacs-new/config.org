...
Segun la documentación de es necesario tener instalado elpa-counsel en el sistema
...
Luego activamos las demas cosas
#+begin_src emacs-lisp
    (elpaca counsel
      :emsure t
      :config (counsel-mode))
...
#+RESULTS:
: [nil 26400 5195 300190 nil elpaca-process-queues nil nil 458000 nil]
...
#+RESULTS:
: [nil 26401 21944 243380 nil elpaca-process-queues nil nil 921000 nil]
